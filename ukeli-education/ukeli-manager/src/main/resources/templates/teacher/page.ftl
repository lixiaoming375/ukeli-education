                    ...
                    <div class="col-xs-12 col-sm-8">
                        <form class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="keyword" placeholder="教师名称">
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                   <th class="hidden-xs center"><input type="checkbox" class="i-checks"/></th>
									...
									<th class="hidden-sm hidden-xs">科目名称</th>
									<!-- <th class="hidden-sm hidden-xs">图片地址</th> -->
...
<script src="${adminPath}/res/js/teacher/teacher.js?ver=${version}"></script>
</body>
</html>