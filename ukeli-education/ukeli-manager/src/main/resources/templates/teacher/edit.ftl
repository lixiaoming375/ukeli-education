		   ...
		   <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="name"  id="name" type="text" class="col-sm-11" value="${teacher.name!}" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
           ...
           <div class="space-2"></div>
 		   <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="typename"  id="typename" type="text" class="col-sm-11" value="${teacher.typename!}" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                      <div id="fileList" class="uploader-list" ></div>
                        ...
                        <label class="col-sm-2 control-label no-padding-right" for="imageurl">图片地址：</label>
                        <div class="col-sm-10">
            ...
            <div class="space-2"></div>
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="detail"> 教师介绍: </label>
                        <div class="col-sm-10">
                            <div class="clearfix">
                                 <textarea  id="detail" rows="10" class="col-sm-12" name="detail"  >${teacher.detail!}
                                 </textarea>
                            </div>
                        </div>
                    </div>
