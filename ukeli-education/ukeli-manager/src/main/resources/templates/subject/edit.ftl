        ...
        <form class="form-horizontal"  id="subjectForm" method="post" action="${adminPath}/subject/save.json">
 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <textarea class="layui-textarea" id="content" name="content"  style="display: none">${subject.content!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <textarea class="layui-textarea" id="analysis" name="analysis" style="display: none">${subject.analysis!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                 <textarea  id="detail" rows="3" cols="20" class="col-sm-12" name="detail"  >${subject.detail!}</textarea>
                            </div>
                        </div>
                    </div>
	                </div>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-4 col-md-8">
                    <button class="btn btn-info" id="submittype2" type="submit" style="display: none"><i class="ace-icon fa fa-check bigger-110"></i>下一步</button>
                    <button class="btn btn-info" id="submittype1" type="submit" style="display: none"><i class="ace-icon fa fa-check bigger-110"></i>保存</button>
                    &nbsp; &nbsp; &nbsp;
...
<script>
   ...
   $(document).ready(function () {  
    ...
    function nextedit(subjectid){
      ...
      Eymjs.dialog.showUrl('答案选项',Eymjs.ukeli.url.subject.NEXTEDIT,{subjectid:subjectid},760,650);
    }
