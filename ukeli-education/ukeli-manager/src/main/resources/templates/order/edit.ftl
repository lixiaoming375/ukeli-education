 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                                <input name="ordernumber"  type="text" id="ordernumber" class="col-sm-11" value="${order.ordernumber!}" placeholder="订单号"/>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                                <input name="username" type="text"  id="username" class="col-sm-11" value="${order.username!}" placeholder="用户名为用户手机号"/>
                            </div>
                        </div>
                    </div>
                </div>
 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                                <input name="nickname" type="text"  id="nickname" class="col-sm-11" value="${order.nickname!}" placeholder="用户名昵称"/>
                            </div>
                        </div>
                         <label class="col-sm-2 control-label no-padding-right" for="productid"> 产品名称: </label>
                        <div class="col-sm-4">
                            <div class="clearfix">
                               <select name="productid"  id="productid"  data-placeholder="产品名称" style="width: 180px;vertical-align:middle;" aria-invalid="false" class="help-block m-b-none" >
 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                               <select name="orderstatus"  id="orderstatus"  data-placeholder="订单状态" style="width: 180px;vertical-align:middle;" aria-invalid="false" class="help-block m-b-none" >
                        ...
                        <div class="col-sm-4">
                             <div class="clearfix">
                              <select name="paystatus"  id="paystatus"  data-placeholder="订单状态" style="width: 180px;vertical-align:middle;" aria-invalid="false" class="help-block m-b-none" >
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
	                             <div class="input-group">
						          ...
						          <input type="text" name="totalmarketprice"  id="totalmarketprice" class="col-sm-11 form-control" value="${order.totalmarketprice!}"/>
                        ...
                        <div class="col-sm-4">
                             <div class="input-group">
                              <span class="input-group-addon">¥</span>
					          <input type="text" name="totalprice"  id="totalprice" class="col-sm-11 form-control" value="${order.totalprice!}"/>
					          <span class="input-group-addon">.00</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                             <div class="input-group">
                              <span class="input-group-addon">¥</span>
					          <input type="text" name="payprice"  id="payprice" class="col-sm-11 form-control" value="${order.payprice!}"/>
					          <span class="input-group-addon">.00</span>
                            </div>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                     <label class="col-sm-2 control-label no-padding-right" for="paytype"> 支付类型: </label>
                        <div class="col-sm-4">
                            <div class="clearfix">
                              <select name="paytype"  id="paytype"  data-placeholder="订单状态" style="width: 180px;vertical-align:middle;" aria-invalid="false" class="help-block m-b-none">
				                    <option value='0' >----请选择----</option>
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                                <input name="amount" type="text" id="amount" class="col-sm-11" value="${order.amount!}" placeholder="正整数"/>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="clearfix">
                                <input name="payorder" type="text" id="payorder" class="col-sm-11" value="${order.payorder!}" placeholder="正整数"/>
                            </div>
                        </div>
                    </div>
                </div>
