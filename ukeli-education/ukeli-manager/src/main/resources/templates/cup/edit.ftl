            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="times"  id="times" type="text" class="col-sm-11" value="${cup.times!}" placeholder="单位分钟" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="score"  id="score" type="text" class="col-sm-11" value="${cup.score!}" placeholder="请输入正整数" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
