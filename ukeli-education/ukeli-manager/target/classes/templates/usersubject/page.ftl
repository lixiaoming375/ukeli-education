                    ...
                    <div class="col-xs-12 ">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nameForSearch" name="nameForSearch" placeholder="题目名称" style="width:100px">
                            </div>
                            <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                   <th class="hidden-xs center"><input type="checkbox" class="i-checks"/></th>
									...
									<th class="hidden-sm hidden-xs">题目编号</th>
									<th class="hidden-sm hidden-xs">题目名称</th>
...
<script src="${adminPath}/res/js/usersubject/usersubject.js?ver=${version}"></script>
</body>
</html>