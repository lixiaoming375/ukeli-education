                    ...
                    <div class="col-xs-7">
                       ...
                       <div class="widget-main">
		                 ...
		                 <div class="row pb10 wb100">
		                    <div class="col-xs-12 col-sm-9">
		                        <form class="form-inline">
		                            <div class="form-group">
		                                <label for="examName">关键字：</label>
		                                <input type="text" class="form-control" id="examName" placeholder="考试名称" style="width: 100px;vertical-align:middle;">
		                            </div>
		                            <div class="form-group">
		                                <label for="statusForSearch">状态：</label>
		                                <select name="statusForSearch"  id="statusForSearch"  data-placeholder="状态" style="width: 100px;vertical-align:middle;">
		                    ...
		                    <div class="col-xs-12 col-sm-3 t_ar">
                         ...
                         <div>
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-sm hidden-xs">总试题量</th>
                                    <th class="hidden-sm hidden-xs">考试时长</th>
		                            ...
		                            <table class="table table-striped table-bordered table-hover" id="contentTableForSubject">
		                              <thead>
		                               <tr>
										...
										<th class="hidden-sm hidden-xs">试题分数</th>
										<th class="hidden-sm hidden-xs">排序</th>
	                                    <th style="border-right:#CCC solid 1px;">操作</th>
		                               </tr>
		                              </thead>
...
<script src="${adminPath}/res/js/exam/exam.js?ver=${version}"></script>
</body>
</html>