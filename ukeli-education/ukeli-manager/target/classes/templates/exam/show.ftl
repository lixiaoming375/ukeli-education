            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="name"  id="name" class="col-sm-11" value="${exam.name!}" readonly style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                                <input name="times"  id="times" class="col-sm-11" value="${exam.times!}" readonly style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="clearfix">
                           <textarea class="layui-textarea" id="remark" name="remark"   style="display: none">${exam.remark!}
                           </textarea>
                            </div>
                        </div>
                    </div>
