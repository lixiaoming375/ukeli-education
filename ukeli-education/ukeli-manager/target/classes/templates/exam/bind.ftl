...
<div class="main-container ace-save-state" id="main-container">
                ...
                <div class="row pb10 wb100">
                    <div class="col-xs-12 col-sm-8">
                        <form class="form-inline">
                            ...
                            <button type="button" class="btn btn-inverse btn-sm" id="researchbtnForBind"><span class="ace-icon fa fa-search icon-on-right bigger-110"></span>重置</button>
   ...
   <input name="examId" id="examId" type="hidden" value=${examId!} />

<script src="${adminPath}/res/js/exam/bind.js?ver=${version}"></script>
