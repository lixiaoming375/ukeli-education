                    ...
                    <div class="col-xs-12 col-sm-8">
                        <form class="form-inline">
                              <div class="form-group">
                                <label for="usernameForSearch">用户：</label>
                                <input type="text" class="form-control" id="usernameForSearch" placeholder="用户" style="width: 150px;vertical-align:middle;">
                            </div>
                            <div class="form-group">
                                <label for="nameForSearch">试题名称：</label>
                                <input type="text" class="form-control" id="nameForSearch" placeholder="试题名称" style="width: 150px;vertical-align:middle;">
                            </div>
                             <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                   <th class="hidden-xs center"><input type="checkbox" class="i-checks"/></th>
									...
									<th class="hidden-sm hidden-xs">是否修改</th>
...
<script src="${adminPath}/res/js/usersubjectwrong/usersubjectwrong.js?ver=${version}"></script>
</body>
</html>