<div class="row margin0">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" id="userPassForm" method="post" action="${adminPath}/user/editpw.json">
            ...
            <div class="space-4"></div>
            <div class="form-group">
                <label class="col-sm-4 control-label no-padding-right" for="password">用户密码：</label>
                <div class="col-sm-8">
                    <input type="password" name="password" id="password" placeholder="必填:用户密码"  class="col-sm-11" required="">
                </div>
            </div>
