	                    ...
	                    <div class="col-xs-12">
	                        <form class="form-inline">
	                            <div class="form-group">
	                                ...
	                                <input type="text" class="form-control" id="keyword" placeholder="杯赛名称" style="width: 100px;vertical-align:middle;">
	                            </div>
	                             <div class="form-group">
		                                <label for="cuptypeidForSearch">杯赛类型：</label>
		                                <select name="cuptypeidForSearch"  id="cuptypeidForSearch"  data-placeholder="杯赛类型" style="width: 100px;vertical-align:middle;">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                  <th class="hidden-xs center"></th>
                                    ...
                                    <th class="hidden-sm hidden-xs">杯赛类型</th>
