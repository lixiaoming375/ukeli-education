...
function bindBatch() {
    ...
    if(ids){
      ...
      Eymjs.page.bindFunction(examId,ids,Eymjs.ukeli.url.cup.BINDBYID,"您确定要绑定试题吗?")
    }
}
...
function bind(subjectId) {
    ...
    Eymjs.page.bindFunction(cupId,subjectId,Eymjs.ukeli.url.cup.BINDBYID,"您确定要绑定该试题吗?")
}
