                            ...
                            <table class="table table-striped table-bordered table-hover" id="contentTable">
                                ...
                                <tr>
                                   <th class="hidden-xs center"><input type="checkbox" class="i-checks"/></th>
									...
									<th class="hidden-sm hidden-xs">市场价</th>
									<th class="hidden-sm hidden-xs">商城价</th>
									<th class="hidden-sm hidden-xs">VIP会员价</th>
									<th class="hidden-sm hidden-xs">类型</th>
									<th class="hidden-sm hidden-xs">日期类型</th>
									<th class="hidden-sm hidden-xs">日期数量</th>
...
<script src="${adminPath}/res/js/product/product.js?ver=${version}"></script>
</body>
</html>