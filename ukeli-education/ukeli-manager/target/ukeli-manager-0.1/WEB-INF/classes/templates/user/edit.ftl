        ...
        <form class="form-horizontal"  id="userForm" method="post" action="${adminPath}/user/save.json">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label no-padding-right" for="username"> 用户名: </label>
               <div class="col-sm-8">
	                 <div class="clearfix">
	                  <input type="text" name="username"  id="username" class="col-sm-11" value="${user.username!}" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
	                 </div>
                </div>
            </div>
            ...
            <div class="space-2"></div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label no-padding-right" for="username"> 密码: </label>
                        <div class="col-sm-8">
                            <div class="clearfix">
                                <input type="text" name="password"  id="password" class="col-sm-11" value="${user.password!}" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
