 			 ...
 			 <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="clearfix">
                                <input name="password"  id="password" readonly class="col-sm-11" value="${user.password!}" style="width:300px; height:30px;vertical-align:middle; border:1px solid #d1d1d2;" />
                            </div>
                        </div>
                    </div>
                </div>
