...
public class ExamSubjectDo  extends BaseTableEntry implements Serializable {				//
	...
	public ExamSubjectDo(){}

	public ExamSubjectDo(Long id,Long examid,Long subjectid,Integer serial,Integer score,Long iorder,Short status,Long adderid,String adder,String editer,Long editerid,String remark1,String remark2,Date addtime,Date edittime,Short slock){
		this.id=id;
		this.examid=examid;
