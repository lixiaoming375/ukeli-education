...
public class UserSubjectWrongDo  extends BaseTableEntry implements Serializable {				//
	...
	private String ismod;   //是否修改|1|1|1

	private String ext_userName;
	private String ext_subjectName;
	
	public UserSubjectWrongDo(){}

	public UserSubjectWrongDo(Long id,Long userid,Long subjectid,Integer vtype,String ismod,Long iorder,Short status,Long adderid,String adder,String editer,Long editerid,String remark1,String remark2,Date addtime,Date edittime,Short slock){
		this.id=id;
		this.userid=userid;
	...
	*/
	public void setIsmod(String ismod){
		this.ismod = StringUtils.trim(ismod);
	}
