...
<div class="page-block bg-blue-img page-header">
    <div class="wrap clearfix">
        <div class="fl page-header-title">
            ...
            <h1 class="fl fz-xl fwb t-white">${cup.name!} 考试</h1>
        </div>
        ...
        <div class="fr page-content">
         ...
         <div class="radius-5 bg-white ovh mb20 page-content-box exam-enter-box">
                <div class="page-content-title clearfix">
                    <h2 class="fl bg-blue t-white fwb fz-l">${cup.name!}</h2>
                </div>
                <div class="page-content-description">
                    ${cup.remark!}
                </div>
            </div>
            <div class="tc mb10"><a href="${webPath!}cup/allsubject/${cup.id}.html" class="btn btn-xl btn-red btn-enterExam">开始考试</a></div>
            <div class="tc mb40">试卷总分： <span class="t-red">${cup.score!}</span> 分，共计 <span class="t-red">${cup.totalsubject!}</span> 题，考试时间 <span class="t-red">${cup.times!}</span> 分钟</div>
    </div>
</div>
<!-- 二级页内容 end -->
