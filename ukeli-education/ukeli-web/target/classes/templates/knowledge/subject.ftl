...
<div class="page-block bg-blue-img page-header">
    <div class="wrap clearfix">
        <div class="fl page-header-title">
            ...
            <h1 class="fl fz-xl fwb t-white">${knowledge.nodename!} >> ${indexSubject.name !}</h1>
        </div>
        ...
        <div class="fl page-aside">
            ...
            <#if subjectList??>
	            <#list subjectList as subject>
	               ...
	               <a  href="${webPath}knowledge/subject/${subject.id!}.html?knowledgeid=${knowledge.id!}" id="subject_${subject.id}" class="btn btn-blue-l btn-l db <#if subject.id==indexSubject.id>hover</#if> over ">例${subject_index+1}-${subject.name}</a>
	               <#else>
	               <a  href="${webPath}knowledge/subject/${subject.id!}.html?knowledgeid=${knowledge.id!}" id="subject_${subject.id}" class="btn btn-blue-l btn-l db <#if subject.id==indexSubject.id>hover</#if> ">例${subject_index+1}-${subject.name}</a>
	               </#if>
	            </#list>
            </#if>
            </div>
            ...
            <div class="radius-5 bg-white ovh mb10">
                ...
                <div class="page-content-box">
                    ...
                    <div class="page-content-description">
                        <p>${indexSubject.content !}</p>
                        <p><#if indexSubject.imgurl??><image src="${indexSubject.imgurl!}" alt="题目图片"/></#if></p>
                    </div>
                </div>
            </div>
