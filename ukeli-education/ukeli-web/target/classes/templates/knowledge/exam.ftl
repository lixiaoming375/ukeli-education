...
<div class="page-block bg-blue-img page-header">
    <div class="wrap clearfix">
        <div class="fl page-header-title">
            ...
            <h1 class="fl fz-xl fwb t-white">${knowledge.nodename!}测试卷</h1>
        </div>
        <a href="javascript:goBack()" class="fr btn btn-l btn-blue-t bor-w-2" >返回视频</a>
    </div>
</div>
<!-- 页头 end -->
    ...
    <div class="wrap clearfix">
        <div class="fl page-aside">
            <div class="bg-blue radius-5 mb10 page-aside-menu page-aside-exam">
                ...
                -->
                <div class="bg-green t-white exam-info mb10 radius-5">
                                   试卷介绍
                </div>
                <div class="bg-blue-1 t-white exam-info mb10 radius-5">
                    <p>本试卷共有<b class="t-orange">${totalsubject!}</b>道题目</p>
                    <p>共计<b class="t-orange">${score!}</b>分</p>
                </div>
        ...
        <div class="fr page-content">
            <#if list??>
            <#list list as knowledgevo>
                <div class="radius-5 bg-white ovh mb20 page-content-box quiz-box">
                    <div class="page-content-title clearfix">
                        <h2 class="fl bg-blue t-white fwb fz-l"><em>${knowledgevo_index+1}</em></h2>
                    </div>
                    <div class="quiz-content">
                        <div class="quiz-txt fz-l">
	                        ${knowledgevo.subjectDo.content}
                        </div>
                        <span style="color: rgb(255, 0, 0);"><#if (knowledgevo.subjectDo.detail)??&&(knowledgevo.subjectDo.detail)!="" >提示：${knowledgevo.subjectDo.detail!} </#if></span>
                        <table>
                        <#list knowledgevo.list as option>
	                       <tr class="quiz-txt fz-l"> <td>${option.optiionname !} :</td> <td>${option.optioncontext !}</td> </tr>
                        </#list>
                        </table>
                    </div>
                    <div class="quiz-form clearfix">
                        <input type="text" name="answer${knowledgevo.subjectDo.id}" class="input-txt fl" placeholder="请输入您的正确答案">
                    </div>
                </div>
            </#list>
